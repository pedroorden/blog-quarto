...
![](https://www.arte-online.net/var/arte_online_net/storage/images/arte-online/notas/eduardo-mac-entyre-y-miguel-angel-vidal/888351-1-esl-AR/Eduardo-Mac-Entyre-y-Miguel-Angel-Vidal_nota.jpg "Eduardo Mac Entyre y Miguel Ángel Vidal (60s)"){width="100%"}
...
```{r df, error=FALSE, warning=FALSE, message=FALSE, out.width = '100%'}
...
```{r espiral, error=FALSE, warning=FALSE, message=FALSE, warning=FALSE,dataout.width = '100%'}
